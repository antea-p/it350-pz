...
$table_name = 'CPU';
$primary_key = 'cpu_model';
$columns = ['cpu_manufacturer'];

if (!empty($_POST)) {
    if ($_POST['submit'] === 'Add') {
        $repository->insert_cpu($_POST[$primary_key], $_POST['cpu_manufacturer']);
    } elseif ($_POST['submit'] === 'Update') {
        $repository->update_cpu($_POST[$primary_key], $_POST['cpu_manufacturer']);
    } elseif ($_POST['submit'] === 'Delete') {
        $repository->delete_cpu($_POST[$primary_key]);
    }
}

$rows = $repository->get_cpus();
