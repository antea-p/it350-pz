...
$table_name = 'Sponsor';
$primary_key = 'id_sponsor';
$columns = ['sponsor_name'];

if (!empty($_POST)) {
    if ($_POST['submit'] === 'Add') {
        $repository->insert_sponsor($_POST[$primary_key], $_POST['sponsor_name']);
    } elseif ($_POST['submit'] === 'Update') {
        $repository->update_sponsor($_POST[$primary_key], $_POST['sponsor_name']);
    } elseif ($_POST['submit'] === 'Delete') {
        $repository->delete_sponsor($_POST[$primary_key]);
    }
}

$rows = $repository->get_sponsors();
