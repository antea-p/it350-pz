...
$primary_key = 'id_tournament';
$columns = ['id_arena', 'id_game', 'tournament_name'];

if (!empty($_POST)) {
    if ($_POST['submit'] === 'Add') {
        $repository->insert_tournament($_POST[$primary_key], $_POST['id_arena'], $_POST['id_game'], $_POST['tournament_name']);
    } elseif ($_POST['submit'] === 'Update') {
        $repository->update_tournament($_POST[$primary_key], $_POST['id_arena'], $_POST['id_game'], $_POST['tournament_name']);
    } elseif ($_POST['submit'] === 'Delete') {
        $repository->delete_tournament($_POST[$primary_key]);
    }
}

$rows = $repository->get_tournaments();
