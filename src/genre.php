...
if (!empty($_POST)) {
    if ($_POST['submit'] === 'Add') {
        $repository->insert_genre($_POST[$primary_key], $_POST['genre_name']);
    } elseif ($_POST['submit'] === 'Update') {
        $repository->update_genre($_POST[$primary_key], $_POST['genre_name']);
    } elseif ($_POST['submit'] === 'Delete') {
        $repository->delete_genre($_POST[$primary_key]);
    }
}

$rows = $repository->get_genres();
