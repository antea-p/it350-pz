...
$table_name = 'GPU';
$primary_key = 'gpu_model';
$columns = ['gpu_manufacturer'];

if (!empty($_POST)) {
    if ($_POST['submit'] === 'Add') {
        $repository->insert_gpu($_POST[$primary_key], $_POST['gpu_manufacturer']);
    } elseif ($_POST['submit'] === 'Update') {
        $repository->update_gpu($_POST[$primary_key], $_POST['gpu_manufacturer']);
    } elseif ($_POST['submit'] === 'Delete') {
        $repository->delete_gpu($_POST[$primary_key]);
    }
}

$rows = $repository->get_gpus();
